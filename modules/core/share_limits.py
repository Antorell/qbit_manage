...
class ShareLimits:
    ...
    def update_share_limits_for_group(self, group_name, group_config, torrents):
        ...
        for torrent in torrents:
            ...
            if group_config["set_force_start"] and not (self.config.on_add or torrent.state_enum.is_downloading):
    ...
    def tag_and_update_share_limits_for_torrent(self, torrent, group_config):
        ...
        if group_config["set_force_start"] and self.config.on_add and (
